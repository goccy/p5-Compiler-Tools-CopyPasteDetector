...
# "Here's to alcohol, the cause ofâand solution toâall life's problems."
sub write_chunk {
  my ($self, $chunk, $cb) = @_;
...
<div class='code-clone-start b61fe4ec9aa673c5a0fb9911d05dd803'></div>  my $self = shift;

  # Parse
  my $headers = $self->headers;
  $headers->parse($self->{pre_buffer});
  $self->{pre_buffer} = '';
<div class='code-clone-end b61fe4ec9aa673c5a0fb9911d05dd803'></div>
  # Finished
