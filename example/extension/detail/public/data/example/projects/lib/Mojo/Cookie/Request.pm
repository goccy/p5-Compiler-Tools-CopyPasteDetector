...
sub to_string {
<div class='code-clone-start e3b11d668efffce15b51a83053f46f64'></div>  my $self = shift;
  return '' unless my $cookie = $self->name;
  $cookie .= '=';
  my $value = $self->value;
  $cookie .= $value =~ /[,;"]/ ? quote($value) : $value if defined $value;
<div class='code-clone-end e3b11d668efffce15b51a83053f46f64'></div>  return $cookie;
}
