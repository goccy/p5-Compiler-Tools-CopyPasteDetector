...
<div class='code-clone-start b1914dd17eaa1b1870e0868faf2ad04a'></div>    unless ($headers->connection) {
...
<div class='code-clone-end b1914dd17eaa1b1870e0868faf2ad04a'></div>    $self->{write} = $req->start_line_size;
  }
...
<div class='code-clone-start b1914dd17eaa1b1870e0868faf2ad04a'></div>    unless ($headers->connection) {
    ...
    # Write start line
    $self->{state} = 'write_start_line';
<div class='code-clone-end b1914dd17eaa1b1870e0868faf2ad04a'></div>    $self->{write} = $res->start_line_size;
  }
