...
<div class='code-clone-start 4f2fab5e03f69677c2119389f76e0169'></div>            if (my $pp = $curr->attributes->{PathPart}) {
                unshift(@parts, $pp->[0])
                    if (defined $pp->[0] && length $pp->[0]);
            }
            $parent = $curr->attributes->{Chained}->[0];
            $curr = $self->_actions->{$parent};
<div class='code-clone-end 4f2fab5e03f69677c2119389f76e0169'></div>            unshift(@parents, $curr) if $curr;
        }
        if ($parent ne '/') {
...
<div class='code-clone-start 4f2fab5e03f69677c2119389f76e0169'></div>        if (my $pp = $curr->attributes->{PathPart}) {
        ...
        $parent = $curr->attributes->{Chained}->[0];
        $curr = $self->_actions->{$parent};
<div class='code-clone-end 4f2fab5e03f69677c2119389f76e0169'></div>    }
