...
sub list {
<div class='code-clone-start 901571e32766305a4dcac361046a934d'></div>    my ( $self, $c ) = @_;
...
<div class='code-clone-end 901571e32766305a4dcac361046a934d'></div>    my $paths = Text::SimpleTable->new(
