...
sub _do_visit {
<div class='code-clone-start c7870ce9943fb2202ffbf97c57a6b3d1'></div>    my $self = shift;
    my $opname = shift;
    my ( $c, $command ) = @_;
    my ( $action, $args, $captures ) = $self->_command2action(@_);
<div class='code-clone-end c7870ce9943fb2202ffbf97c57a6b3d1'></div>    my $error = qq/Couldn't $opname("$command"): /;
...
<div class='code-clone-start c7870ce9943fb2202ffbf97c57a6b3d1'></div>    my $self = shift;
    ...
    my ( $c, $command ) = @_;
    my ( $action, $args, $captures ) = $self->_command2action(@_);
<div class='code-clone-end c7870ce9943fb2202ffbf97c57a6b3d1'></div>
    if (!$action) {
