...
sub AUTOLOAD {
<div class='code-clone-start 7b355ba49d800d0b59c55a26277ab137'></div>  my $self = shift;

  # Method
  my ($package, $method) = our $AUTOLOAD =~ /^([\w\:]+)\:\:(\w+)$/;
  croak qq/Undefined subroutine &${package}::$method called/
    unless blessed $self && $self->isa(__PACKAGE__);
<div class='code-clone-end 7b355ba49d800d0b59c55a26277ab137'></div>
  # Search children
...
sub replace {
  ...
  # Find and replace
<div class='code-clone-start bb0482b69c79069f916a70d76c59db55'></div>  my $parent = $tree->[3];
  my $i = $parent->[0] eq 'root' ? 1 : 4;
  for my $e (@$parent[$i .. $#$parent]) {
    last if $e == $tree;
    $i++;
  }
<div class='code-clone-end bb0482b69c79069f916a70d76c59db55'></div>  splice @$parent, $i, 1, @{_parent($new, $parent)};
...
<div class='code-clone-end bb0482b69c79069f916a70d76c59db55'></div>
  # Add
