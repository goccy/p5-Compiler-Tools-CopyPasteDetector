...
<div class='code-clone-start 42569e0f95c84556c41f3f4f8205e82e'></div>      $stream->on(
        close => sub {
          my $c = $self->{connections}->{$id};
...
<div class='code-clone-end 42569e0f95c84556c41f3f4f8205e82e'></div>      $c->{connect}->($self, $id) if $c->{connect};
    }
  );
...
<div class='code-clone-end 42569e0f95c84556c41f3f4f8205e82e'></div>      $self->$accept($id) if $accept;
    }
  );
