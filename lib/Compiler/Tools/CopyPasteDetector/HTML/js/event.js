...
{
    $(".cpd-file-tree-area").hover(function(e) {
        if (!$(this).hasClass("expanded")) {
            var before_width = $(this).width();
            var width = get_auto_pixel_size($(this), "width");
            var length = parseInt(width) - before_width;
            $(this).animate({width: width, display: "visible"},
                            {queue: false, duration: 100, complete: function(){}});
            $(".cpd-main-menu-area").animate({ "margin-left" : -length + "px" },
                                             {queue: false, duration: 100, complete: function(){}});
            $(this).addClass("expanded");
        }
    }, function(e) {
        if ($(this).hasClass("expanded")) {
            $(this).animate({width: "24%", display: "hidden"},
                            {queue: false, duration: 100, complete: function(){}});
            $(".cpd-main-menu-area").animate({ "margin-left" : length + "px" },
                                             {queue: false, duration: 100, complete: function(){}});
